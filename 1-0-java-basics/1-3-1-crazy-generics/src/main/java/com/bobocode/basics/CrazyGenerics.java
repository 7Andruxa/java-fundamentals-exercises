...
public class CrazyGenerics {
     ...
     * interface and {@link Comparable}k interface, and provides a default implementation of a compareTo method that
    ...
    static class CollectionUtil {
         ...
         */
        public static <T extends BaseEntity> java.util.Optional<T> findMax(Iterable<T> elements, Comparator<? super T> comparator) {
        ...
        private static <T> void swapHelper(List<T> elements, int i, int j) {
            T tempElement = elements.get(j);
            elements.set(j, elements.get(i));
            elements.set(i, tempElement);
        }
